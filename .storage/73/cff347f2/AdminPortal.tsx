...
export default function AdminPortal() {
  ...
  const userTypeData = [
    { name: 'Clients', value: users.filter(u => u.userType === 'client').length, color: '#3B82F6' },
    { name: 'Transporters', value: users.filter(u => u.userType === 'transporter').length, color: '#10B981' },
    { name: 'Admins', value: users.filter(u => u.userType === 'admin').length, color: '#8B5CF6' }
  ];
                ...
                <CardContent>
                  <ResponsiveContainer width="100%" height={300}>
                    <LineChart data={monthlyData}>
                      ...
                      <Line type="monotone" dataKey="loads" stroke="#10B981" strokeWidth={2} />
                    </LineChart>
                  </ResponsiveContainer>
                </CardContent>
              </Card>
                    ...
                    <TableRow key={user.id}>
                      <TableCell>
                        <div>
                          ...
                          <div className="text-sm text-gray-500">{user.profile.contactPerson}</div>
                        </div>
                      </TableCell>
