        ...
        <div className="w-full max-w-md space-y-8 animate-fadeIn">
          ...
          <Card className="shadow-lg border-0 rounded-2xl bg-gray-50">
            <CardHeader className="pb-3">
              <CardTitle className="text-sm font-semibold" style={{ color: '#0A1C3F' }}>Demo Accounts</CardTitle>
                ...
                {demoAccounts.map((account) => (
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      <div className={`p-2 rounded-lg ${account.type === 'Admin' ? 'bg-red-100' : account.type === 'Client' ? 'bg-blue-100' : 'bg-green-100'}`}>
      ...
      <div className="flex-1 p-8 flex items-center justify-center relative overflow-hidden" style={{ backgroundColor: '#0A1C3F' }}>
        ...
        <div className="absolute inset-0 opacity-10">
          ...
          <div className="absolute bottom-1/4 left-1/2">
            <div className="w-12 h-12 rounded-full opacity-50" style={{ backgroundColor: '#33A852' }} />
          </div>
        </div>

        <div className="relative z-10 text-white max-w-lg space-y-8 animate-slideInRight">
          ...
          <div className="grid grid-cols-3 gap-4 pt-8 border-t border-white/20">
            <div className="text-center">
              <div className="text-2xl font-bold" style={{ color: '#33A852' }}>10K+</div>
              <div className="text-sm text-gray-200">Active Users</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold" style={{ color: '#33A852' }}>50K+</div>
              <div className="text-sm text-gray-200">Loads Delivered</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold" style={{ color: '#33A852' }}>25+</div>
