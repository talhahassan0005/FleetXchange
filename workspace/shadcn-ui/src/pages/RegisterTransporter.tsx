...
import { Loader2, ArrowLeft, User, Truck, Mail, Phone, MapPin, FileText } from 'lucide-react';
        ...
        <div className="w-full max-w-2xl">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Join FleetXchange to find loads and grow your transport business
            </p>
          </div>
          ...
          <Card className="shadow-xl border-0 bg-white rounded-2xl">
            <CardHeader className="space-y-1 pb-4" style={{ backgroundColor: '#0A1C3F' }}>
              ...
              <CardDescription className="text-blue-100">
                Create your transporter account to start bidding on loads
              </CardDescription>
            </CardHeader>
            <CardContent className="p-6">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                >
                  ...
                  {loading ? 'Creating Account...' : 'Create Transporter Account'}
                </Button>
              </form>
